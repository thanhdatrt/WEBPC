<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUpAdmin.aspx.cs" Inherits="WebPC.Admin.SignUpAdmin" %>
...
<body>
    <form id="form1" runat="server">
        <div class="overlay">
                ...
                <!--        buttons -->
                <!--      button LogIn -->
                       <asp:Button ID="btnSignup1" OnClick="btnSignup_Click" class="button log-in" runat="server" Text="Sign Up" />
                   </div>
