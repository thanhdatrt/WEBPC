<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginAdmin.aspx.cs" Inherits="WebPC.Admin.LoginAdmin" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="overlay">
                ...
                <!--     Sign Up button -->
                       <asp:LinkButton ID="btnSignup" OnClick="btnSignup_Click1" class="btn button submits sign-up" runat="server">
                           Sign Up
